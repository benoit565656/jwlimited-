...
export function LightboxModal() {
  ...
  return (
    ...
    >
      {/* Top action toolbar */}
      <div className="absolute top-3 sm:top-4 left-3 sm:left-4 right-3 sm:right-4 z-20 flex justify-between items-center text-ivory">
      ...
      <div className="relative w-full h-full max-w-6xl flex flex-col justify-center items-center pt-12 sm:pt-14 pb-20 sm:pb-24 overflow-y-auto no-scrollbar">
        <div 
          className={`relative w-full transition-all duration-300 flex items-center justify-center ${
            isZoomed ? 'max-w-none h-[110vh] cursor-zoom-out' : 'max-h-[60vh] sm:max-h-[65vh] aspect-[3/2] cursor-zoom-in'
          }`}
          onClick={() => setIsZoomed(!isZoomed)}
        >
          <Image
